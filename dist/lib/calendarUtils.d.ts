...
export declare function getCalendarStartDate(date: Date, weekStartsOn?: DayOfWeek): Date;
...
export declare function onDatePickerOpen(event: React.MouseEvent<HTMLButtonElement, MouseEvent>, calendarDatePickerRef: React.RefObject<Calendar>): void;
